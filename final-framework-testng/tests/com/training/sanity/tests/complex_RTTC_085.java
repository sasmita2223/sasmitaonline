...
public class complex_RTTC_085 {
	...
	@Test(dataProvider="excel-inputsRTTC_85", dataProviderClass=LoginDataProviders.class)
	public void validLoginTest(String oredrIdText,String orderStatus,String dateAdded,String customer,String totalTextBox,String dateModified) throws InterruptedException 
	{
		...
		orderStatusComplete.enterValOrderIDText(oredrIdText); //exceldata
		orderStatusComplete.clickOnOrderStatus(orderStatus); //exceldata
		orderStatusComplete.clickOnDateAdded(dateAdded);	//exceldata
		orderStatusComplete.enterValForCustomer(customer); //exceldata
		orderStatusComplete.enterValaTotalTextBox(totalTextBox); //exceldata
		orderStatusComplete.clickOnDateModified(dateModified);//exceldata
		orderStatusComplete.clickOnFilterButton();
